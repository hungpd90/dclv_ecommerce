...
func NewApplication(productCollection *mongo.Collection, userCollection *mongo.Collection, orderCollection *mongo.Collection, payloadCollection *mongo.Collection, messageCollection *mongo.Collection) *Application {
	return &Application{
